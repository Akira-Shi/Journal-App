  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <p className="text-lg md:text-xl text-red-800 mb-8">
          Capture your thoughts, track your moods, and reflect on your journey
          in a beautiful, secure space.
        </p>
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-t from-rose-50 via-transparent to-transparent pointer-events-none z-10" />
          <div className="bg-white rounded-2xl  p-4 max-full mx-auto">
            <div className="border-b border-rose-100 pb-4 mb-4 flex items-center justify-between">
            ...
            <div className="space-y-4 p-4">
              ...
              <Skeleton className="h-4 bg-rose-100 rounded w-3/4" />
              <Skeleton className="h-4 bg-rose-100 rounded w-full" />
              <Skeleton className="h-4 bg-rose-100 rounded w-2/3" />
            </div>
          </div>
        </div>
        <div className="flex justify-center gap-4">
          ...
          <Link href="#features">
            <Button
              variant="outline"
              className="px-8 py-6 rounded-full border-red-600 text-red-600 hover:bg-rose-100"
            >
              Learn More
            </Button>
          </Link>
      ...
      <div className="space-y-24 mt-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 ">
          ...
          <div className="space-y-4 bg-white rounded-2xl shadow-xl p-6 border border-rose-100">
            {/* Editor Preview */}
            <div className="flex gap-2 mb-6">
              <div className="h-8 w-8 rounded bg-rose-100"></div>
              <div className="h-8 w-8 rounded bg-rose-100"></div>
              <div className="h-8 w-8 rounded bg-rose-100"></div>
            </div>
            <div className="h-4 bg-rose-50 rounded w-3/4"></div>
            <div className="h-4 bg-rose-50 rounded w-full"></div>
            <div className="h-4 bg-rose-50 rounded w-2/3"></div>
            <div className="h-4 bg-rose-50 rounded w-1/3"></div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 md:flex-row-reverse">
          ...
          <div className="space-y-4 bg-white rounded-2xl shadow-xl p-6 border border-rose-100 md:order-1">
            {/* Analytics Preview */}
            <div className="h-40 bg-gradient-to-t from-rose-100 to-rose-50 rounded-lg"></div>
      ...
      {/* CTA Section */}
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-rose-100 to-amber-100">
